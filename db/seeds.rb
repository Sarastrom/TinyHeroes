...
wish1 = WishList.new(title: "Winter Disco Chalet Doll Houses", amount: 50, user: kid2)
...
wish2 = WishList.new(title: "Marvel Spider-Man: Far From Home Titan Hero Series", amount: 50, user: kid1)
...
wish3 = WishList.new(title: "Avengers Legends Ant-Man Gear", amount: 50, user: kid2)
...
wish4 = WishList.new(title: "Harry Potter Hogwarts Battle Book of Monsters Expans50ion", amount: 50, user: kid2)
